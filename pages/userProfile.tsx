        ...
        <View className="flex-1 bg-black">
            <ScrollView className="flex-1 bg-gray-900">
                <View className="absolute top-0 left-0 right-0 pt-16">
                        <Text className="text-lg text-white text-center pt-4 font-bold">[Nombre de usuario]</Text>
                ...
                <View className="flex-1 pt-20 mt-20">
                    <View>
                        <Image
                            ...
                            source={icon}/>
                        <Text className="text-white text-center pt-4 italic">[@identificador]</Text>
                    </View>
                    ...
                    <View className="flex-row justify-center gap-1 pt-4">
                        <View className="flex-col items-center">
                            <TouchableOpacity>
                                <Text className="text-white text-md bg-green-600 rounded-lg p-3 font-bold w-[8rem] text-center">Seguir</Text>
                            </TouchableOpacity>
                        </View>
                        <View>
                            <TouchableOpacity>
                                <Text className="text-white text-md bg-gray-600 rounded-lg p-3 font-bold w-[8rem] text-center">Mensajes</Text>
                            </TouchableOpacity>
                        </View>
                        <View>
                            <TouchableOpacity>
                    ...
                    <View className="items-center pt-6">
                        <Text className="text-white font-bold">Descripcion: aqui va la descripcion que describe</Text>
                    </View>
                </View>
            </ScrollView>
        </View>
